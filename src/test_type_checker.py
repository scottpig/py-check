...
'''
import unittest
from type_checker import checked
...
class TestCase(unittest.TestCase):
    ...
    def test_paramtype_invalid(self):
        self.assertRaises(TypeError, lambda: int_to_int(1.1)   )
    ...
    def test_rtype_none_invalid(self):
        self.assertRaises( TypeError, lambda: int_to_none_bad(6) )
        
    def test_cannot_cast_rval(self):
        self.assertRaises( TypeError, lambda: unchecked_to_int("foo") )
        
    def test_cast_rval(self):
        self.assertIsInstance(unchecked_to_int(2.4567), int)
        self.assertEqual(unchecked_to_int(2.354789), 4)
        
    def test_misc(self):    
        self.assertRaises( TypeError, lambda: default_values(4,6.0) )
    ...
    def test_result_is_container(self):
        ...
        self.assertRaises(TypeError, returns_bad_set)
        
    def test_checked_arg(self):
        self.assertEqual(checked_arg(1,3,4,4), 4)
        self.assertRaises(TypeError, lambda: checked_arg(1,2,3,4.0))
    ...
    def test_bad_annotation(self):
        self.assertRaises(TypeError, lambda: bad_default_val() )
